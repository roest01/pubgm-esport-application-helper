...
const initalMatchStartTime = "20:00";
            ...
            if (!createdStages.has(stageItem.stage)) {
                ...
                for (let stageDayItem of event_json.items) {
                    if (stageDayItem.stage === stageName) {
                        console.log("create stageDay for stage ", stageName, " with name ", stageDayItem.day_name);

                        let matchDayName = stageDayItem.day_name //match day
                        ...
                        for (let map of matches) {
                            ...
                            console.log(matchDayName, matchDayDate, "we play ", map, "on stage day", stageDayItem.day_name);
